  ...
  return (
    <footer className="flex md:flex-row justify-between px-[30px] py-[40px] md:px-[76px] md:py-12 text-sm flex-col text-center md:text-left gap-10 md:gap-0 max-w-sm h-fit md:max-w-[840px] lg:max-w-[1440px] mx-auto">
      ...
      <div className="w-fit h-fit md:w-fit md:h-[233px] lg:h-[188px] flex flex-col md:justify-between items-center gap-5">
        ...
        >
          <a
            href="https://www.instagram.com/ristek.csui/"
            target="_blank"
          >
            <Image
          ...
          <a
            href="https://twitter.com/RistekCSUI"
            target="_blank"
          >
            <Image
          ...
          <a
            href="https://www.linkedin.com/company/ristek-fakultas-ilmu-komputer-universitas-indonesia"
            target="_blank"
          >
            <Image
          ...
          <a
            href="https://liff.line.me/1645278921-kWRPP32q?accountId=rye2953f&openerPlatform=webview&openerKey=webview%3AunifiedSearch"
            target="_blank"
          >
            <Image
              src="/icons/line.svg"
          ...
          <a
            href="https://medium.com/ristek-fasilkom"
            target="_blank"
          >
            <Image
